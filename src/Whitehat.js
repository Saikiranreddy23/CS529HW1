...
import * as d3 from 'd3import React, {useRef,useMemo} from 'react';
import useSVGCanvas from './useSVGCanvas.js';
    ...
    const mapGroupSelection = useMemo(()=>{
        ...
        if(svg !== undefined & props.map !== undefined & props.data !== undefined){
            ...
            function drawLegend(){
                ...
                const legendTitle = {
                    'x': legendX - barWidth-60,
                    'y': bounds.y+ 10*barHeight+160,
